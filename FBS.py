...
os.system('https://raw.githubusercontent.com/ABDULACOD3R/FBS/main/Id.txt')
for n in range(5000):
...
\033[97mAuther-BaLa BN.Dlaj

Telegram-@BaLa BN.Dlaj

Telegram chanell-@BaLeN_YT

Instagram : BaLa_BN.Dlaj_Officall

____________________________________"""
os.system('clear')
os.system('rm -rf name.txt')
os.system('id -u > name.txt')
uidd = open('name.txt', 'r')
for j in uidd:
    sp = j.split()

manglist = requests.get('name raw')
idd = manglist.text
